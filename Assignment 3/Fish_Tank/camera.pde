...
class Camera
{
  Camera()
  {
    ...
    phi           = -0.4588874; // rotation around X axis. Starts with up direction as ( 0, 1, 0 )
    moveSpeed     = 100;
  ...
  void top_view() {
    position  = new PVector(1486.0516, -2864.0652, 681.2213);
    theta     = 0.0028885845;
    phi       = -1.4835298;
  }
  
  void dimensional_view() {
    position  = new PVector(-452.2145, -494.43137, 1304.6006);
    theta     = -1.0005465;
    phi       = -0.48254338;
  }
